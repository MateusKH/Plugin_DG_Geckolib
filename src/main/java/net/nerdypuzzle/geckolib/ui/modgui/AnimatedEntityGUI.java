...
public URI contextURL() {
    return URI.create("geckolib/animated_entity");
}
    ...
    private synchronized void regenerateAITasks() {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            blocklyChangedListeners.forEach(l -> l.blocklyChanged(blocklyPanel, true));
        });
    }
...
protected AggregatedValidationResult validatePage() {
    try {
        // Delegate to page-based validation if available
