...
public class AnimatedItemGUI extends ModElementGUI<AnimatedItem> implements GeckolibElement {
    ...
    private final JCheckBox firstPersonArms = L10N.checkbox("elementgui.common.enable");
    ...
    public AnimatedItemGUI(MCreator mcreator, ModElement modElement, boolean editingMode) {
        ...
        this.immuneToFire = L10N.checkbox("elementgui.common.enable");
        this.destroyAnyBlock = L10N.checkbox("elementgui.common.enable");
        this.enableArmPose = L10N.checkbox("elementgui.animateditem.enable_arm_pose");
        this.stayInGridWhenCrafting = L10N.checkbox("elementgui.common.enable");
        this.disableSwing = L10N.checkbox("elementgui.common.enable");
        this.damageOnCrafting = L10N.checkbox("elementgui.common.enable");
        this.hasGlow = L10N.checkbox("elementgui.common.enable");
        ...
        this.isFood = L10N.checkbox("elementgui.common.enable");
        ...
        this.isMeat = L10N.checkbox("elementgui.common.enable");
        this.isAlwaysEdible = L10N.checkbox("elementgui.common.enable");
    ...
    protected void initGUI() {
        this.onRightClickedInAir = new ProcedureSelector(this.withEntry("item/when_right_clicked"), this.mcreator, L10N.t("elementgui.common.event_right_clicked_air"), Dependency.fromString("x:number/y:number/z:number/world:world/entity:entity/itemstack:itemstack"));
        this.onCrafted = new ProcedureSelector(this.withEntry("item/on_crafted"), this.mcreator, L10N.t("elementgui.common.event_on_crafted"), Dependency.fromString("x:number/y:number/z:number/world:world/entity:entity/itemstack:itemstack"));
        this.onRightClickedOnBlock = (new ProcedureSelector(this.withEntry("item/when_right_clicked_block"), this.mcreator, L10N.t("elementgui.common.event_right_clicked_block"), VariableTypeLoader.BuiltInTypes.ACTIONRESULTTYPE, Dependency.fromString("x:number/y:number/z:number/world:world/entity:entity/itemstack:itemstack/direction:direction/blockstate:blockstate"))).makeReturnValueOptional();
        this.onEntityHitWith = new ProcedureSelector(this.withEntry("item/when_entity_hit"), this.mcreator, L10N.t("elementgui.item.event_entity_hit"), Dependency.fromString("x:number/y:number/z:number/world:world/entity:entity/sourceentity:entity/itemstack:itemstack"));
        this.onItemInInventoryTick = new ProcedureSelector(this.withEntry("item/inventory_tick"), this.mcreator, L10N.t("elementgui.item.event_inventory_tick"), Dependency.fromString("x:number/y:number/z:number/world:world/entity:entity/itemstack:itemstack/slot:number"));
        this.onItemInUseTick = new ProcedureSelector(this.withEntry("item/hand_tick"), this.mcreator, L10N.t("elementgui.item.event_hand_tick"), Dependency.fromString("x:number/y:number/z:number/world:world/entity:entity/itemstack:itemstack/slot:number"));
        this.onStoppedUsing = new ProcedureSelector(this.withEntry("item/when_stopped_using"), this.mcreator, L10N.t("elementgui.item.event_stopped_using"), Dependency.fromString("x:number/y:number/z:number/world:world/entity:entity/itemstack:itemstack/time:number"));
        this.onEntitySwing = new ProcedureSelector(this.withEntry("item/when_entity_swings"), this.mcreator, L10N.t("elementgui.item.event_entity_swings"), Dependency.fromString("x:number/y:number/z:number/world:world/entity:entity/itemstack:itemstack"));
        this.onDroppedByPlayer = new ProcedureSelector(this.withEntry("item/on_dropped"), this.mcreator, L10N.t("elementgui.item.event_on_dropped"), Dependency.fromString("x:number/y:number/z:number/world:world/entity:entity/itemstack:itemstack"));
        // Corrigido o entry do "finish using" para não conflitar com "stopped using"
        this.onFinishUsingItem = new ProcedureSelector(this.withEntry("item/player_useitem_finish"), this.mcreator, L10N.t("elementgui.item.player_useitem_finish"), Dependency.fromString("x:number/y:number/z:number/world:world/entity:entity/itemstack:itemstack"));
        this.glowCondition = (new ProcedureSelector(this.withEntry("item/condition_glow"), this.mcreator, L10N.t("elementgui.item.glowcondition"), AbstractProcedureSelector.Side.CLIENT, true, VariableTypeLoader.BuiltInTypes.LOGIC, Dependency.fromString("x:number/y:number/z:number/world:world/entity:entity/itemstack:itemstack"))).makeInline();
        ...
        destal3.add("West", PanelUtils.totalCenterInPanel(ComponentUtils.squareAndBorder(this.texture, L10N.t("elementgui.item.texture"))));
        destal2.add("North", destal3);

        JPanel destal = new JPanel(new GridLayout(8, 2, 15, 5));
        destal.setOpaque(false);
        JComponent destal1 = PanelUtils.join(0, new Component[]{HelpUtils.wrapWithHelpButton(this.withEntry("item/glowing_effect"), L10N.label("elementgui.item.glowing_effect")), this.hasGlow, this.glowCondition});
        destal.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/special_information"), L10N.label("elementgui.common.tooltip_tip")));
        destal.add(this.specialInformation);
        destal.add(HelpUtils.wrapWithHelpButton(this.withEntry("geckolib/animation_name"), L10N.label("elementgui.animateditem.idle_animation")));
        destal.add(this.idle);
        destal.add(HelpUtils.wrapWithHelpButton(this.withEntry("geckolib/disable_swing"), L10N.label("elementgui.animateditem.disable_swing")));
        destal.add(this.disableSwing);
        destal.add(new JEmptyBox());
        destal.add(new JEmptyBox());
        destal.add(HelpUtils.wrapWithHelpButton(this.withEntry("geckolib/first_person"), L10N.label("elementgui.animateditem.first_person")));
        destal.add(this.firstPersonArms);
        destal.add(HelpUtils.wrapWithHelpButton(this.withEntry("geckolib/model_arm"), L10N.label("elementgui.animateditem.left_arm")));
        destal.add(this.leftArm);
        destal.add(HelpUtils.wrapWithHelpButton(this.withEntry("geckolib/model_arm"), L10N.label("elementgui.animateditem.right_arm")));
        ...
        this.hasGlow.addActionListener((e) -> this.updateGlowElements());
        // Garantir que a condição de brilho comece desabilitada se hasGlow estiver off
        updateGlowElements();
        ...
        rent.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder((Color) UIManager.get("MCreatorLAF.BRIGHT_COLOR"), 1), L10N.t("elementgui.animateditem.model"), 0, 0, this.getFont().deriveFont(12.0F), (Color) UIManager.get("MCreatorLAF.BRIGHT_COLOR")));
        ...
        subpane2.add(HelpUtils.wrapWithHelpButton(this.withEntry("common/creative_tab"), L10N.label("elementgui.common.creative_tabs")));
        subpane2.add(this.creativeTabs);
        subpane2.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/stack_size"), L10N.label("elementgui.common.max_stack_size")));
        subpane2.add(this.stackSize);
        subpane2.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/enchantability"), L10N.label("elementgui.common.enchantability")));
        subpane2.add(this.enchantability);
        subpane2.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/destroy_speed"), L10N.label("elementgui.item.destroy_speed")));
        subpane2.add(this.toolType);
        subpane2.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/damage_vs_entity"), L10N.label("elementgui.item.damage_vs_entity")));
        ...
        subpane2.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/immune_to_fire"), L10N.label("elementgui.item.is_immune_to_fire")));
        subpane2.add(this.immuneToFire);
        subpane2.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/can_destroy_any_block"), L10N.label("elementgui.item.can_destroy_any_block")));
        subpane2.add(this.destroyAnyBlock);
        subpane2.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/container_item"), L10N.label("elementgui.item.container_item")));
        ...
        subpane2.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/animation"), L10N.label("elementgui.item.item_animation")));
        subpane2.add(this.animation);
        subpane2.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/use_duration"), L10N.label("elementgui.item.use_duration")));
        ...
        this.updateFoodPanel();
        foodSubpane.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/is_food"), L10N.label("elementgui.item.is_food")));
        foodSubpane.add(this.isFood);
        foodSubpane.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/nutritional_value"), L10N.label("elementgui.item.nutritional_value")));
        foodSubpane.add(this.nutritionalValue);
        foodSubpane.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/saturation"), L10N.label("elementgui.item.saturation")));
        foodSubpane.add(this.saturation);
        foodSubpane.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/result_item"), L10N.label("elementgui.item.eating_result")));
        foodSubpane.add(PanelUtils.centerInPanel(this.eatResultItem));
        foodSubpane.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/is_meat"), L10N.label("elementgui.item.is_meat")));
        foodSubpane.add(this.isMeat);
        foodSubpane.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/always_edible"), L10N.label("elementgui.item.is_edible")));
        ...
        inventoryProperties.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder((Color) UIManager.get("MCreatorLAF.BRIGHT_COLOR"), 1), L10N.t("elementgui.common.page_inventory"), 4, 0, this.getFont(), (Color) UIManager.get("MCreatorLAF.BRIGHT_COLOR")));
        inventoryProperties.setOpaque(false);
        inventoryProperties.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/bind_gui"), L10N.label("elementgui.item.bind_gui")));
        inventoryProperties.add(this.guiBoundTo);
        inventoryProperties.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/inventory_size"), L10N.label("elementgui.item.inventory_size")));
        inventoryProperties.add(this.inventorySize);
        inventoryProperties.add(HelpUtils.wrapWithHelpButton(this.withEntry("item/inventory_stack_size"), L10N.label("elementgui.common.max_stack_size")));
        ...
        this.name.setValidator(new TextFieldValidator(this.name, L10N.t("elementgui.item.error_item_needs_name")));
        ...
        enableArmPose.addActionListener((e) -> armPoseList.setEnabled(enableArmPose.isSelected()));
        ...
        this.addPage(L10N.t("elementgui.common.page_visual"), pane2);           // index 0
        this.addPage(L10N.t("elementgui.animateditem.page_hands"), paneHands);  // index 1
        this.addPage(L10N.t("elementgui.common.page_properties"), pane3);       // index 2
        this.addPage(L10N.t("elementgui.item.food_properties"), foodProperties);// index 3
        this.addPage(L10N.t("elementgui.common.page_advanced_properties"), advancedProperties); // index 4
        this.addPage(L10N.t("elementgui.common.page_triggers"), pane4);         // index 5
        if (!this.isEditingMode()) {
        ...
        this.idle.setValidator(new TextFieldValidator(this.idle, L10N.t("elementgui.animateditem.needs_idle")));
        this.idle.enableRealtimeValidation();
    }

    private void updateFoodPanel() {
        boolean enable = this.isFood.isSelected();
        this.nutritionalValue.setEnabled(enable);
        this.saturation.setEnabled(enable);
        this.isMeat.setEnabled(enable);
        this.isAlwaysEdible.setEnabled(enable);
        this.eatResultItem.setEnabled(enable);
    }
    ...
    public void reloadDataLists() {
        ...
        ComboBoxUtil.updateComboBoxContents(this.guiBoundTo, ListUtils.merge(Collections.singleton("<NONE>"), this.mcreator.getWorkspace().getModElements().stream().filter((var) -> var.getType() == ModElementType.GUI).map(ModElement::getName).collect(Collectors.toList())), "<NONE>");

        ComboBoxUtil.updateComboBoxContents(this.geoModel, ListUtils.merge(Collections.singleton(""), PluginModelActions.getGeomodels(this.mcreator).stream().map(File::getName).filter((s) -> s.endsWith(".geo.json")).collect(Collectors.toList())), "");

        ComboBoxUtil.updateComboBoxContents(this.displaySettings, ListUtils.merge(Collections.singleton(""), PluginModelActions.getDisplaysettings(this.mcreator).stream().map(File::getName).filter((s) -> s.endsWith(".json")).collect(Collectors.toList())), "");
    }

    protected AggregatedValidationResult validatePage(int page) {
        if (page == 2) { // "Properties" page index
            return new AggregatedValidationResult(new IValidable[]{this.name});
        } else if (page == 0) { // "Visual" page index
    ...
    return URI.create("geckolib/animated_item");
    }
