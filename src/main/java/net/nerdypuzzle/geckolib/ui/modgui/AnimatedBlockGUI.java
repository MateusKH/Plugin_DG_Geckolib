...
public class AnimatedBlockGUI extends ModElementGUI<AnimatedBlock> implements GeckolibElement {
    ...
    public AnimatedBlockGUI(MCreator mcreator, ModElement modElement, boolean editingMode) {
        ...
        this.material = new DataListComboBox(this.mcreator, DataListLoader.loadDataList("blockmaterials"));
    ...
    public AnimatedBlock getElementFromGUI() {
        ...
        block.material = String.valueOf(this.material.getSelectedItem());
    ...
    @Override
    public java.net.URI contextURL() {
       return java.net.URI.create("https://mcreator.net/wiki/geckolib-plugin");
    }
